...
VALUES ('Munoz', 'Do your best!!');

INSERT INTO quotes (author_last_name, author_first_name, content)
VALUES ('Munoz', 'Marcus', 'Do your best');
...
SELECT * FROM quotes WHERE author_last_name = 'Munoz';
